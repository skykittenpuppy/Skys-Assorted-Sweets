...
public class ModItemGroups {
    ...
    public static void registerModItemGroups(){
        ...
        ((IToggleableItemGroup)ECHOING_VOID).setRequiredFeatures(ModFeatureFlags.ECHOING_VOID);
    }
    ...
    public static final ItemGroup ECHOING_VOID = registerItemGroup("echoing_void", ModBlocks.FLAXEN_EPHYTA.asItem(), (displayContext, entries) -> {
