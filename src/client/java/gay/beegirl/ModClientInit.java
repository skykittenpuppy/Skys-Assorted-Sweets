...
public class ModClientInit implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_COAL_ORE, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_IRON_ORE, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_COPPER_ORE, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_GOLD_ORE, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_REDSTONE_ORE, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_EMERALD_ORE, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_LAPIS_ORE, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_DIAMOND_ORE, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.BLACKSTONE_GOLD_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.BASALT_GOLD_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(Blocks.NETHER_QUARTZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.BLACKSTONE_QUARTZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.BASALT_QUARTZ_ORE, RenderLayer.getCutout());

		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.WHITE_QUARTZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GRANITE_WHITE_QUARTZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DIORITE_WHITE_QUARTZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ANDESITE_WHITE_QUARTZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_WHITE_QUARTZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DEEPSLATE_WHITE_QUARTZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TUFF_WHITE_QUARTZ_ORE, RenderLayer.getCutout());

		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.RUBY_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GRANITE_RUBY_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DIORITE_RUBY_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ANDESITE_RUBY_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_RUBY_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DEEPSLATE_RUBY_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TUFF_RUBY_ORE, RenderLayer.getCutout());

		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.SAPPHIRE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GRANITE_SAPPHIRE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DIORITE_SAPPHIRE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ANDESITE_SAPPHIRE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_SAPPHIRE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DEEPSLATE_SAPPHIRE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TUFF_SAPPHIRE_ORE, RenderLayer.getCutout());

		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TOPAZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GRANITE_TOPAZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DIORITE_TOPAZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ANDESITE_TOPAZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_TOPAZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DEEPSLATE_TOPAZ_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TUFF_TOPAZ_ORE, RenderLayer.getCutout());

		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.CITRINE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GRANITE_CITRINE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DIORITE_CITRINE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ANDESITE_CITRINE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_CITRINE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DEEPSLATE_CITRINE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TUFF_CITRINE_ORE, RenderLayer.getCutout());

		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ALEXANDRITE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GRANITE_ALEXANDRITE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DIORITE_ALEXANDRITE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ANDESITE_ALEXANDRITE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_ALEXANDRITE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DEEPSLATE_ALEXANDRITE_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TUFF_ALEXANDRITE_ORE, RenderLayer.getCutout());

		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.SPINEL_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GRANITE_SPINEL_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DIORITE_SPINEL_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ANDESITE_SPINEL_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DRIPSTONE_SPINEL_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DEEPSLATE_SPINEL_ORE, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TUFF_SPINEL_ORE, RenderLayer.getCutout());
